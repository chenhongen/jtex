...
public interface ITPackageCollection extends Iterable<ITPackage>
{
  ITPackageCollection addPackage(ITPackage p);
  void removePackage(ITPackage p);
  void removePackage(String p);
  ITPackage getPackage(String p);
  void clearPackages();
}
