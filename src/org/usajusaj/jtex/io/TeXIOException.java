 ...
 * @author Matej Usaj
 */
public class TeXIOException extends IOException
{
  public TeXIOException()
  {
    super();
  }

  public TeXIOException(String s)
  {
    super(s);
  }
  
  public TeXIOException(Throwable t)
  {
    super(t);
  }

  public TeXIOException(String s, Throwable t)
  {
    super(s, t);
  }
}
